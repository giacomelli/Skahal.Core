...
namespace ExitGames.Client.Photon.LoadBalancing
{
    ...
    public class LoadBalancingClient : IPhotonPeerListener
    {
       ...
       // private int clientId;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ExitGames.Client.Photon.LoadBalancing.LoadBalancingClient"/> class.
		/// </summary>
       ...
       //     this.clientId = ++clientCount;
		...
		/// Initializes a new instance of the <see cref="ExitGames.Client.Photon.LoadBalancing.LoadBalancingClient"/> class.
		/// </summary>
		/// <param name="masterAddress">Master address.</param>
		...
		/// <param name="customGameProperties">Custom game properties.</param>
		/// <param name="propsListedInLobby">Properties listed in lobby.</param>
